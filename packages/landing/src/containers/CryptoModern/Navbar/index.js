...
import LogoImage from 'common/assets/image/cryptoModern/logo.jpg';
import LogoImageAlt from 'common/assets/image/cryptoModern/logo.jpg';
  ...
  return (
    <NavbarWrapper className="navbar">
      <Container>
        ...
        <Button type="button" iconPosition={"left"} icon={<Icon icon={menu}></Icon>} className="trail" title="SELECT WALLET"></Button>
      </Container>
